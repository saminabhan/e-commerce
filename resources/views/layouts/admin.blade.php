...
<head>
    ...
    <meta name="author" content="Sami Store" />
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('home.index') }}" class="">
                                        ...
                                        <div class="text">Back To Shop</div>
                                    </a>
                                </li>
                ...
                <div class="section-content-right">
                        ...
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{ asset('images/logo/sami-logo.png') }}"
                                        data-light="{{ asset('images/logo/sami-logo.png') }}" data-dark="{{ asset('images/logo/sami-logo.png') }}"
                                        data-width="154px" data-height="52px" data-retina="{{ asset('images/logo/sami-logo.png') }}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">{{ ucfirst(Auth::user()->name) }}</span>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 Infinity Co.</div>
                        </div>
                    </div>
